/**
 * Stepper motor usage example with constant speed.
 *
 * Usage
...
constexpr float STEPPER_MOTOR_MAX_SPEED = 1000.0f;
...
int main()
{
    ...
    CHECK_ERROR(stepper_motor.set_mode_constant_speed(STEPPER_MOTOR_MAX_SPEED * STEPPER_MOTOR_SUBSTEP));
